...
export function MobileBlocker() {
  ...
  // Don't render the blocker on desktop
  if (!isMobile) return null

  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0a0a0a] px-8">
      {/* Background gradient similar to main site */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0d4f5e]/30 via-[#0a0a0a] to-[#2d1b4e]/30" />
      ...
      <div className="relative z-10 text-center">
        <h1
          className="mb-4 text-3xl tracking-tight text-white/90"
        ...
        >
          This experience is optimized for desktop viewing. Please open on a larger screen for the best experience.
        </p>
      </div>
